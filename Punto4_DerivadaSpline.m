...
dV = ppval(pp_der,puntos);

tabla = table(puntos',dV',...
    'VariableNames',{'Frecuencia_kHz','DerivadaSpline'});
...
figure
plot(ff,ppval(pp_der,ff),'LineWidth',1.5)
grid on
xlabel('Frecuencia (kHz)')
ylabel('dV/df')
title('Derivada obtenida mediante spline')